/**
 * BC Student Projects Slider — nav, autoplay + progress, lazy warm-up, light parallax
 * Depends on: section.bc-projects
 * Prev/next: [data-bc-projects="prev"|"next"]
 */
(function () {
  "use strict";

  var SEL_ROOT = ".bc-projects";
  var SEL_SLIDE = ".bc-projects__slide";
  var SEL_PREV = '[data-bc-projects="prev"]';
  var SEL_NEXT = '[data-bc-projects="next"]';
  ...
  function init(root) {
    if (!root || root.dataset.bcProjectsInit === "1") return;
    root.dataset.bcProjectsInit = "1";
    ...
    if (!reduceMotion) {
      var maxP = parseFloat(getComputedStyle(root).getPropertyValue("--bc-projects-parallax")) || 10;
      var raf = null;
      var nx = 0;
      var ny = 0;
