/**
 * BC Qualifications Slider — nav, autoplay + progress, lazy warm-up, light parallax
 * Depends on: section.bc-qual
 * Prev/next: [data-bc-qual="prev"|"next"]
 */
(function () {
  "use strict";

  var SEL_ROOT = ".bc-qual";
  var SEL_SLIDE = ".bc-qual__slide";
  var SEL_PREV = '[data-bc-qual="prev"]';
  var SEL_NEXT = '[data-bc-qual="next"]';
  var SEL_CURRENT = "[data-bc-current]";
  var SEL_TOTAL = "[data-bc-total]";
  var SEL_PROGRESS = ".bc-qual__progress-fill";
  var SEL_VISUAL = ".bc-qual__visual";

  var AUTOPLAY_MS = 6000;
  /** Keep in sync with --bc-qual-fade in CSS (0.45s → 450) */
  var TRANS_MS = 450;
  ...
  function init(root) {
    if (!root || root.dataset.bcQualInit === "1") return;
    root.dataset.bcQualInit = "1";
    ...
    if (!reduceMotion) {
      var maxP = parseFloat(getComputedStyle(root).getPropertyValue("--bc-qual-parallax")) || 10;
      var raf = null;
      var nx = 0;
      var ny = 0;
